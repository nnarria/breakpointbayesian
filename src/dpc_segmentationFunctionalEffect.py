...
# INPUTS
# serie: the observations (array n x 1)
...
# be included in the functional part. By convention eta[0] = 1.
...
def segmentation_bias_MH(serie, nbiter, nburn, lec1, lec2, Fmatrix, nbSegInit,
    ...
    # assigns from 0 to (nbSegInit-1)-1
...
# %%
##############################################################################
# The two steps of M-H and Gibbs sampler are integrated for the 
...
def dbp_with_function_effect (
    ...
    #print('data_serie.shape: ' + data_serie.shape)
    #print('data_serie.shape.reshape(-1,1): ' + data_serie.reshape(-1,1))
    
    estim = estimation_moy_biais(
        data_serie.reshape(-1,1), itertot, burnin, lec1, lec2, 
