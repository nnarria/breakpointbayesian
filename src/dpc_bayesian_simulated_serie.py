...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec  3 01:48:20 2020
...
p2 = 5
nbsimu = 1
series = ss.simuSeries(M, n, K, muChoix, varianceError, pHaar, p1, p2)
    
# Obtaining the serie 
data_serie = np.array((series[5]["mu"] + series[5]["biais"] + 
                        series[5]["erreur1"]))
